...
query_mappings = {
    ...
    "How severe is pain_in_heart?": "severity_level(pain_in_heart, Severity).",
    "What dietary recommendations are there for gastric?": "dietary_recommendation(gastric, Recommendation).",
